"""
Configurable training script for Frequency-Aware Model.
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description='Train Frequency-Aware Model for next-location prediction',
    ...
    model_group.add_argument('--dropout', type=float, default=0.25,
                            help='Dropout rate')
    ...
    early_stop_group.add_argument('--patience', type=int, default=30,
    ...
    output_group.add_argument('--checkpoint-dir', type=str, default='./checkpoints_freq',
                             help='Directory to save checkpoints')
    output_group.add_argument('--name', type=str, default='freq_aware',
...
def compute_frequencies(train_path):
    """Compute location frequencies from training data."""
...
def print_config(config):
    ...
    print(f"  Model type:         Frequency-Aware Temporal")
...
def main():
    ...
    print("Computing location frequencies from training data...")
    location_freq = compute_frequencies(config['train_path'])
    print(f"Computed frequencies for {len(location_freq)} locations")
    print()
